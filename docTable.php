...
$totalRows = $conn->query("SELECT COUNT(*) as count FROM users WHERE userType = '1'")->fetch_assoc()['count'];

// Calculate total number of pages
$totalPages = ceil($totalRows / $rowsPerPage);

// Fetch doctors' data
$sql = "SELECT userName, userEmail, userTel FROM users WHERE userType = '1' LIMIT $startRow, $rowsPerPage";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_user'])) {
    ...
    $update_sql = "UPDATE users SET userName='$user_name', userEmail='$user_email', userType='$user_type' WHERE userEmail='$user_email'";
