...
$totalRows = $conn->query("SELECT COUNT(*) as count FROM users WHERE userType = '2'")->fetch_assoc()['count'];

// Calculate total number of pages
$totalPages = ceil($totalRows / $rowsPerPage);

// Fetch patients' data
$sql = "SELECT userName, userEmail, userTel FROM users WHERE userType = '2' LIMIT $startRow, $rowsPerPage";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_user'])) {
    ...
    header("Location: table.php"); // Redirect back to the main page
}
